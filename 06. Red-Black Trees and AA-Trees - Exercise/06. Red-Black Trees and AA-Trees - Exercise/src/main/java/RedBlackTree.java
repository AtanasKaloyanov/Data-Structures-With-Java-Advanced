...
public class RedBlackTree<Key extends Comparable<Key>, Value> {
    ...
    public Value get(Key key) {
        if (key == null) {
            throw new IllegalArgumentException("Key cannoy be null in get() call");
        }
    ...
    public void put(Key key, Value val) {
        if (key == null) {
            throw new IllegalArgumentException("Key cannot be null in pu() call");
        }
